      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-y-10 md:grid-cols-2 lg:grid-cols-1">
          ...
          {/* <PricingBox
            ...
            subtitle="Explore the world of ADHD with insights into symptoms, causes, and effective coping strategies for improved focus."
          >
          ...
          <PricingBox
            ...
            duration={isMonthly ? "mo" : "yr"}
            subtitle="
            Gain a comprehensive understanding of autism through an overview of its characteristics and manifestations."
          >
            <OfferList text="Free MCQ Test" status="active" />
            <OfferList text="Video Submissions" status="active" />
            <OfferList text="Early Intervention" status="active" />
